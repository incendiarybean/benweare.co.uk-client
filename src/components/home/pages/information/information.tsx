            ...
            >
                <div className='snap-start'>
                    ...
                    <div className='list-wrapper'>
                        ...
                        <a href='https://aws.amazon.com/' className='list item'>
                            AWS CLI
                        </a>

                        <a href='https://www.heroku.com/' className='list item'>
                            HEROKU CLI
                        </a>

                        <a href='https://microk8s.io/' className='list item'>
                            MicroK8s
                        </a>

                        <a href='https://kubernetes.io/' className='list item'>
                            Kubernetes
                        </a>

                        <a href='https://nodejs.org/en/' className='list item'>
                            NodeJS
                        </a>
                    </div>
                </div>
                <div className='snap-start'>
                    ...
                    <div className='list-wrapper'>
                        ...
                        <a href='https://www.python.org/' className='list item'>
                            PYTHON
                        </a>

                        <a href='https://www.php.net/' className='list item'>
                            PHP
                        </a>
                    </div>
                </div>
                ...
                <div className='snap-start'>
                    ...
                    <div className='list-wrapper'>
                        ...
                        <a href='https://reactjs.org/' className='list item'>
                            React (Functional)
                        </a>
