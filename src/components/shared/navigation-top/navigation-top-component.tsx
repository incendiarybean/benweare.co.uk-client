...
const NavigationBar = () => {
    return (
        <div
            ...
            className='sticky top-0 z-40 w-full backdrop-blur-xl sm:backdrop-blur-sm flex-none md:border-b md:border-sky-500/20 dark:border-sky-100/10 bg-transparent'
        >
            <div className='py-4 border-b border-sky-900/10 px-2 md:px-6 md:border-0 dark:border-sky-300/10 flex justify-between items-center'>
                ...
                <div className='mx-4 md:mx-0 flex items-center justify-between md:justify-start w-full'>
                    ...
                    >
                        <span className='py-1 px-2 border border-sky-500 dark:border-sky-400/20 rounded-sm text-sky-500 dark:text-sky-400 hover:text-blue-600 dark:hover:text-sky-600'>
                            benweare.co.uk
                        </span>
                    </a>
