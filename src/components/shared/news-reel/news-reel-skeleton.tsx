...
const NewsReelSkeleton = () => {
    return (
        <div
            ...
            className='animate-fadeIn relative flex w-full rounded-sm lg:shadow-sm flex-col xl:flex-row bg-slate-100 dark:bg-zinc-900 lg:border border-slate-300 dark:border-zinc-600/30'
        >
